...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RestaurantListAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.restaurantAddress.setText("Addres: "+restaurantModelList.get(position).getAddress());
        holder.restaurantHours.setText("Bugün Açık: " + restaurantModelList.get(position).getHours().getTodaysHours());
